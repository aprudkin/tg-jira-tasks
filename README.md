...
Проект предоставляется на условиях [CC0 1.0 Universal](LICENSE). Полный юридический текст: [Creative Commons](https://creativecommons.org/publicdomain/zero/1.0/legalcode). Лицензии сторонних зависимостей сохраняются.
