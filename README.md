...
| `/sprint` | Задачи в текущем спринте |
| `/recent` | Задачи, обновлённые за последние 24 часа |
...
| `/sync [X]` | Включить уведомления (каждые X минут, по умолчанию 30). Бот также уведомляет о ваших собственных действиях. |
