...
### 📲 Things интеграция (macOS/iOS)

| Команда | Описание |
|---------|----------|
| `/things` | Экспорт задач In Progress в Things |
| `/things_sprint` | Экспорт задач спринта в Things |
| `/things_todo` | Экспорт задач бэклога в Things |
