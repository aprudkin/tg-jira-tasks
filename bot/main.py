...
BOT_COMMANDS = [
    ...
    BotCommand(command="track", description="Следить за коллегой: user [эмодзи] [мин]"),
    BotCommand(command="untrack", description="Перестать следить: user"),
    BotCommand(command="tracks", description="Список отслеживаемых коллег"),
